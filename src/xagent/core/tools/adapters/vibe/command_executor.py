    ...
    def description(self) -> str:
        ...
        if self._restrict_paths:
            lines.append(
                ...
                "The policy inspects statically identifiable nested shell "
                "commands and scripts. Runtime-generated file arguments (for "
                "example xargs), active globs or expansions, implicit shell "
                "initialization, unsupported control structures, and scripts "
